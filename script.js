...
document.getElementById('share-kakao').addEventListener('touchstart', shareOnKakao);
document.getElementById('share-twitter').addEventListener('click', shareOnTwitter);
document.getElementById('share-twitter').addEventListener('touchstart', shareOnTwitter);
document.getElementById('share-facebook').addEventListener('click', shareOnFacebook);
document.getElementById('share-facebook').addEventListener('touchstart', shareOnFacebook);

document.getElementById('m-share-kakao').addEventListener('click', shareOnKakao);
document.getElementById('m-share-kakao').addEventListener('touchstart', shareOnKakao);
document.getElementById('m-share-twitter').addEventListener('click', shareOnTwitter);
document.getElementById('m-share-twitter').addEventListener('touchstart', shareOnTwitter);
document.getElementById('m-share-facebook').addEventListener('click', shareOnFacebook);
document.getElementById('m-share-facebook').addEventListener('touchstart', shareOnFacebook);